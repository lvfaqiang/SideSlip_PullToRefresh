...
public class PullToRefreshSwipeRecyclerView extends PullToRefreshBase<SwipeMenuRecyclerView> {
    ...
    public PullToRefreshSwipeRecyclerView(Context context, Mode mode) {
        super(context, mode);
    }

    public PullToRefreshSwipeRecyclerView(Context context, Mode mode, AnimationStyle style) {
    ...
    @Override
    protected SwipeMenuRecyclerView createRefreshableView(Context context,
                                                          AttributeSet attrs) {
        SwipeMenuRecyclerView recyclerView = new SwipeMenuRecyclerView(context, attrs);
        return recyclerView;
    }
